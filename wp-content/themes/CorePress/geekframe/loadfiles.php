...
function corepress_load_style_filse_onadmin($hook)
{
    ...
    if ($hook == 'post.php' || $hook == 'post-new.php') {
        ...
        wp_enqueue_script('vue', 'https://lf3-cdn-tos.bytecdntp.com/cdn/expire-1-M/vue/2.6.14/vue.min.js', array(), THEME_VERSION, false);
        wp_localize_script('tools', 'tools', array('index' => is_home(), 'page' => is_page(), 'post' => is_single()));
        wp_enqueue_script('corepress_element_js', 'https://lf3-cdn-tos.bytecdntp.com/cdn/expire-1-M/element-ui/2.15.7/index.min.js', array(), THEME_VERSION, false);
        wp_enqueue_style('corepress_element_css', 'https://lf26-cdn-tos.bytecdntp.com/cdn/expire-1-M/element-ui/2.15.7/theme-chalk/index.min.css', array(), THEME_VERSION);
...
add_action('login_head', 'CorePressFreeCustomLoginStyle');
function CorePressFreeCustomLoginStyle()
{
    wp_enqueue_style('cp_admin_login', THEME_CSS_PATH . '/admin/login-style.css', array(), THEME_VERSION);
    wp_enqueue_script('cp_admin_login', THEME_JS_PATH . '/admin/login.js', array('jquery'), THEME_VERSION);
    wp_localize_script('cp_admin_login', 'cp_login', options::getLoginData());
}
