    ...
    <div id="app" v-cloak>
        <div class="setmain">
            <div class="header-set-title">
                ...
                <div>
                    <el-link href="https://www.lovestu.com/corepress.html" :underline="false" target="_blank">
                        <el-button icon="el-icon-data-line" size="mini">
                            升级Pro版
                        </el-button>
                    </el-link>
                    <el-link href="http://ghpymtougao.mikecrm.com/J7s2beB" :underline="false" target="_blank">
                        <el-button icon="el-icon-document-checked" size="mini">
                            反馈BUG
                        </el-button>
                    </el-link>
        ...
        <div class="control-plane">
            <el-button @click="save" size="small" :loading="loading.save">保存</el-button>
        </div>
    </div>
<?php
